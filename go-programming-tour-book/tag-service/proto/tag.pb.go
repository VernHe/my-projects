...
var file_tag_proto_rawDesc = []byte{
	...
	0x70, 0x61, 0x67, 0x65, 0x72, 0x32, 0x5f, 0x0a, 0x0a, 0x54, 0x61, 0x67, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x51, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x18,
	...
	0x2e, 0x47, 0x65, 0x74, 0x54, 0x61, 0x67, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x79,
	0x22, 0x14, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x0e, 0x12, 0x0c, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76,
	0x31, 0x2f, 0x74, 0x61, 0x67, 0x73, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2e, 0x2f, 0x70, 0x72, 0x6f,
...
var file_tag_proto_depIdxs = []int32{
	...
	0, // 2: proto.TagService.GetList:input_type -> proto.GetTagListRequest
	2, // 3: proto.TagService.GetList:output_type -> proto.GetTagListReply
...
type TagServiceClient interface {
	GetList(ctx context.Context, in *GetTagListRequest, opts ...grpc.CallOption) (*GetTagListReply, error)
}
...
func (c *tagServiceClient) GetList(ctx context.Context, in *GetTagListRequest, opts ...grpc.CallOption) (*GetTagListReply, error) {
	out := new(GetTagListReply)
	err := c.cc.Invoke(ctx, "/proto.TagService/GetList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TagServiceServer interface {
	GetList(context.Context, *GetTagListRequest) (*GetTagListReply, error)
}
...
func (*UnimplementedTagServiceServer) GetList(context.Context, *GetTagListRequest) (*GetTagListReply, error) {
...
func _TagService_GetList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTagListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TagServiceServer).GetList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.TagService/GetList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TagServiceServer).GetList(ctx, req.(*GetTagListRequest))
	}
...
var _TagService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetList",
			Handler:    _TagService_GetList_Handler,
		},
	},
